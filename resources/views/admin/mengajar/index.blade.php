...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="card col-md-12">
            ...
            @endif
            <div class="card-body">
                <h4 class="card-title">Daftar Mengajar</h4>
                <a href="{{ url('/mengajar/create')}}"><button class="btn btn-primary pull-right">Tambah Data</button></a>
                    ...
                    <table id="myTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $dt->status }}</td>
                                <td>
                                    <a href="{{ url('/mengajar/'.$dt->id.'/edit') }}" class="btn btn-info"><i class="mdi mdi-pencil"></i>Edit</a>
